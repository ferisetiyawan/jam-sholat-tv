...
class AppConstants {
  ...
  static const String cityId = "1225"; // City ID form Adzan API, can be used to fetch prayer times for specific location
  ...
  // --- app_provider.dart ---
  static const int minutesBeforeMaghrib = 30; // live makkah before maghrib, in minutes
  static const int minutesBeforeJumat = 30;// live makkah before jumat, in minutes
